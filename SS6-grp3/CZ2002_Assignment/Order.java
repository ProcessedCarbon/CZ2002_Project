...
public class Order {
	 ...
	 * @param s staff object who is taking the order
	 * @param ts timestamp of the order
	 * @param tn table number of the order
	 * @param d discount of the order
	 */
	 ...
	 * @param m menu object from the SystemManger 
	 */
	 ...
	 * @param dish of alacarte item to be added
	 * @param qty of alacarte item to be added
	 */
	 ...
	 * @param dish of alacarte item to be removed
	 * @param qty of alacarte item to be removed
	 */
	 ...
	 * @param promotion of promotion to be added
	 * @param qty of promotion to be added
	 */
	 ...
	 * @param promotion of promotion to be removed
	 * @param qty of promotion to be removed
	 */
